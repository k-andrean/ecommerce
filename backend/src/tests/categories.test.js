...
describe("Categories API", () => {
  ...
  beforeEach(async () => {
    const newCategory = {
      ...
      description: "Category for summer season",
    };
  ...
  it("should create a new category", async () => {
    const newCategory = {
      name: "Winter Category",
      description: "Category for winter season",
    };
  ...
  it("should update multiple categories", async () => {
    ...
    const updateData = [
      {
        id: multiCategory[0],
        name: "Updated Fall Category",
        description: "Updated fall category description",
      },
      {
        id: multiCategory[1],
        name: "Updated Spring Category",
        description: "Updated spring category description",
      },
    ];
