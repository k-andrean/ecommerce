...
describe("Collections API", () => {
  ...
  beforeEach(async () => {
    const newCollection = {
      ...
      description: "Collection for summer season",
    };
  ...
  it("should create a new collection", async () => {
    const newCollection = {
      ...
      description: "Collection for winter season",
    };
  ...
  it("should create multiple collections", async () => {
    const collectionsData = [
      { name: "Fall Collection", description: "Collection for fall season" },
      {
        ...
        description: "Collection for spring season",
      },
    ];

    const response = await request(app)
      .post("/collections/many")
  ...
  it("should update multiple collections", async () => {
    ...
    const updateData = [
      {
        id: multiCollection[0],
        name: "Updated Fall Collection",
        description: "Updated fall collection description",
      },
      {
        id: multiCollection[1],
        name: "Updated Spring Collection",
        description: "Updated spring collection description",
      },
    ];
