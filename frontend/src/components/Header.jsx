  ...
  categories: [
    {
      ...
      featured: [
        ...
        },
        {
          ...
          imageAlt:
            "Model sitting and typing on computer placed on top of working desk.",
        },
      ],
    },
    {
      ...
      featured: [
        {
          ...
          imageAlt:
            "Model writing on personal diary while sitting on work chair and desk.",
        },
        {
          name: "Basic",
          href: "/products/all",
          ...
          imageAlt:
            "Golden pen high class stationery highlighted on top of white desk.",
        },
        {
          name: "Working",
          href: `/categories/Work%20Chairs?id=47`,
          imageSrc: AccessoryPopularHeader,
          imageAlt: "Chair with table and notebook arrangement.",
        },
        {
          name: "Highlight",
          ...
          imageAlt:
            "Model sitting on chair facing desk with computer and calculator placed on top of desk.",
        },
      ],
    },
  ],
                        ...
                        <div className="grid grid-cols-2 gap-x-4 gap-y-10">
                          {category.featured.map((item) => (
                            <div key={item.name} className="group relative">
                              ...
                              <Link
                                to={item.href}
                                className="mt-6 block text-sm font-medium text-red-400"
                              >
                                <span
                ...
                <div className="flex h-16 items-center justify-between">
                  ...
                  <div className="flex lg:flex-1 items-center">
                    <Link className="flex items center gap-3" to="/">
                      <img className="h-9 w-auto" src={LogoHeader} alt="" />
                  ...
                  <div className="flex flex-1 items-center justify-end">
                    {userId ? (
                      ...
                      <>
                        ...
                        <Link
                          to={"/login"}
                          className="hidden text-sm font-medium text-gray-900 lg:block lg:mr-4"
                        >
                          Login
                        </Link>
                        ...
                        <Link
                          to={"/register"}
                          className="hidden text-sm font-medium text-gray-900 lg:block"
                        >
                          Create Account
                        </Link>
                      </>
                    ...
                    <div className="ml-4 flow-root lg:ml-4">
                      ...
                      >
                        <ShoppingBagIcon
                          className="h-6 w-6 flex-shrink-0 text-gray-900 font-bold"
                          aria-hidden="true"
                        />
