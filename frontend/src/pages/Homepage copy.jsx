...
const categories = [
  {
    ...
    imageSrc: CollectionBook
  },
  {
    name: 'Working Bags',
    href: '#',
    // imageSrc: 'https://tailwindui.com/img/ecommerce-images/home-page-01-category-02.jpg',
    imageSrc: CollectionBag
  },
  {
    name: 'Stationery',
    href: '#',
    // imageSrc: 'https://tailwindui.com/img/ecommerce-images/home-page-01-category-04.jpg',
    imageSrc: CollectionPen
  },
  {
    name: 'Working Desks',
    href: '#',
...
const collections = [
  ...
  {
    name: 'Complementary Desk Collection',
    href: '#',
    ...
    <div className="bg-white">
      ...
      <div className="relative bg-gray-900">
                  ...
                  <div className="flex h-16 items-center justify-between">
                    ...
                    <div className="flex flex-1 items-center justify-end">
                      ...
                      <div className="flex items-center lg:ml-8">
                        ...
                        <a href="#" className="hidden text-sm font-medium text-gray-300 lg:block lg:mr-4">
                          Sign In
                        </a>
                        ...
                        <a href="#" className="hidden text-sm font-medium text-gray-300 lg:block">
                          Create Account
                        </a>
        ...
        <div className="relative mx-auto flex max-w-3xl flex-col items-center px-6 py-32 text-center sm:py-64 lg:px-0">
          <h1 className="text-4xl font-bold tracking-tight text-yellow-500 lg:text-6xl">New arrivals are here</h1>
          ...
          <a
            href="#"
            className="mt-8 font-bold text-red-500 inline-block rounded-md border border-transparent bg-white px-8 py-3 text-base font-medium text-gray-900 hover:bg-gray-100"
          >
            Shop New Arrivals
          </a>
        </div>
      ...
      <main>
        ...
        >
          <div className="relative overflow-hidden rounded-lg">
            ...
            <div className="relative bg-gray-800 bg-opacity-60 px-6 py-32 sm:px-12 sm:py-40 lg:px-16">
              <div className="relative mx-auto flex max-w-3xl flex-col items-center text-center">
                ...
                <a
                  href="#"
                  className="mt-8 font-bold text-red-500 block w-full rounded-md border border-transparent bg-white px-8 py-3 text-base font-medium text-gray-900 hover:bg-gray-100 sm:w-auto"
                >
                  Shop Workspace
                </a>
              </div>
