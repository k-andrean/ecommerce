...
export default function HomePage() {
  ...
  const { data: categoriesRespData, isSuccess: isSuccessCategory } =
    useGetAllCategoriesQuery();
  const { data: collectionsRespData, isSuccess: isSuccessCollection } =
  ...
  useEffect(() => {
    ...
    if (isSuccessCollection && collectionsRespData) {
      ...
      const updatedCollection = collectionsRespData
        .slice(0, 3)
        .map((collection) => ({
          ...collection,
          image_path:
            process.env.REACT_APP_ECOMMERCE_URL +
            collection.image_path.replace(/\\/g, "/"),
        }));
    ...
    <main>
      ...
      <div className="relative bg-gray-900">
        ...
        <div className="relative mx-auto flex max-w-3xl flex-col items-center px-6 py-32 text-center sm:py-64 lg:px-0">
          <h1 className="text-5xl font-bold tracking-tight text-yellow-500 lg:text-7xl mb-4">
      ...
      >
        <div className="px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8 xl:px-0">
          <h2
            id="category-heading"
            className="text-2xl text-red-500 font-bold tracking-tight text-gray-900"
          >
            Shop by Category
          </h2>
          <Link
        ...
        <div className="mt-10 space-y-12 lg:grid lg:grid-cols-3 lg:gap-x-8 lg:space-y-0">
          {collections.map((collection) => (
            ...
            >
              ...
              <h3 className="mt-4 text-base font-bold text-red-500">
                {collection.name}
              </h3>
